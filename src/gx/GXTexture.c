...
void __GXGetTexTileShift(GXTexFmt fmt, u32* rowTileS, u32* colTileS)
{
	...
	{
		*rowTileS = *colTileS = 0;
		OSAssertMsgLine(0x184, 0, "%s: invalid texture format", "GX");
		break;
	}
	}
}
...
u32 GXGetTexBufferSize(u16 width, u16 height, u32 format, u8 mipmap, u8 max_lod)
{
	...
	OSAssertMsgLine(0x194, width <= 1024, "%s: width too large", "GXGetTexBufferSize");
	OSAssertMsgLine(0x195, height <= 1024, "%s: height too large", "GXGetTexBufferSize");
                  ...
                  u8 mipmap)
{
	...
	OSAssertMsgLine(0x1FD, obj, "Texture Object Pointer is null");
	CHECK_GXBEGIN(0x1FF, "GXInitTexObj");
	OSAssertMsgLine(0x200, width <= 1024, "%s: width too large", "GXInitTexObj");
	OSAssertMsgLine(0x201, height <= 1024, "%s: height too large", "GXInitTexObj");
	...
	default:
	{
		OSAssertMsgLine(0x275, 0, "%s: invalid texture format", "GXPreLoadEntireTexture");
		t->loadFormat = 2;
		rowT          = 2;
		colT          = 2;
		break;
                    ...
                    u8 mipmap, u32 tlut_name)
{
	...
	OSAssertMsgLine(0x29B, obj, "Texture Object Pointer is null");
                     ...
                     u8 do_edge_lod, GXAnisotropy max_aniso)
{
	...
	OSAssertMsgLine(0x2C2, obj, "Texture Object Pointer is null");
	...
	OSAssertMsgLine(0x2D1, (u32)min_filt <= 5, "GXInitTexObjLOD: invalid min_filt value");
...
void GXInitTexObjWrapMode(GXTexObj* obj, GXTexWrapMode sm, GXTexWrapMode tm)
{
	...
	OSAssertMsgLine(0x313, obj, "Texture Object Pointer is null");
...
void GXInitTexObjTlut(GXTexObj* obj, u32 tlut_name)
{
	...
	OSAssertMsgLine(0x329, obj, "Texture Object Pointer is null");
...
u16 GXGetTexObjWidth(const GXTexObj* to)
{
	...
	OSAssertMsgLine(0x36C, to, "Texture Object Pointer is null");
...
u16 GXGetTexObjHeight(const GXTexObj* to)
{
	...
	OSAssertMsgLine(0x372, to, "Texture Object Pointer is null");
...
GXTexFmt GXGetTexObjFmt(const GXTexObj* to)
{
	...
	OSAssertMsgLine(0x378, to, "Texture Object Pointer is null");
	return t->format;
}
...
GXTexWrapMode GXGetTexObjWrapS(const GXTexObj* to)
{
	...
	OSAssertMsgLine(0x37E, to, "Texture Object Pointer is null");
...
GXTexWrapMode GXGetTexObjWrapT(const GXTexObj* to)
{
	...
	OSAssertMsgLine(0x384, to, "Texture Object Pointer is null");
...
GXBool GXGetTexObjMipMap(const GXTexObj* to)
{
	...
	OSAssertMsgLine(0x38A, to, "Texture Object Pointer is null");
	return (t->flags & 1) == 1;
}
...
GXTexFilter GXGetTexObjMagFilt(const GXTexObj* tex_obj)
{
	...
	OSAssertMsgLine(0x3B9, tex_obj, "Texture Object Pointer is null");
...
f32 GXGetTexObjMinLOD(const GXTexObj* tex_obj)
{
	...
	OSAssertMsgLine(0x3BF, tex_obj, "Texture Object Pointer is null");
...
f32 GXGetTexObjMaxLOD(const GXTexObj* tex_obj)
{
	...
	OSAssertMsgLine(0x3C5, tex_obj, "Texture Object Pointer is null");
...
GXBool GXGetTexObjBiasClamp(const GXTexObj* tex_obj)
{
	...
	OSAssertMsgLine(0x3D5, tex_obj, "Texture Object Pointer is null");
...
GXBool GXGetTexObjEdgeLOD(const GXTexObj* tex_obj)
{
	...
	OSAssertMsgLine(0x3DB, tex_obj, "Texture Object Pointer is null");
...
GXAnisotropy GXGetTexObjMaxAniso(const GXTexObj* tex_obj)
{
	...
	OSAssertMsgLine(0x3E1, tex_obj, "Texture Object Pointer is null");
...
u32 GXGetTexObjTlut(const GXTexObj* tex_obj)
{
	...
	OSAssertMsgLine(0x3E7, tex_obj, "Texture Object Pointer is null");
	return t->tlutName;
}
...
void GXLoadTexObjPreLoaded(GXTexObj* obj, GXTexRegion* region, GXTexMapID id)
{
	...
	OSAssertMsgLine(0x3FE, obj, "Texture Object Pointer is null");
	OSAssertMsgLine(0x3FE, region, "TexRegion Object Pointer is null");
	CHECK_GXBEGIN(0x400, "GXLoadTexObjPreLoaded");
	OSAssertMsgLine(0x401, id < 8, "%s: invalid texture map ID", "GXLoadTexObj");
	...
	if (!(t->flags & 2)) {
		OSAssertMsgLine(0x413, gx->tlutRegionCallback, "%s: Tex/Tlut Region Callback not set", "GXLoadTexObj/PreLoaded");
		tlr = (GXTlutRegionPriv*)gx->tlutRegionCallback(t->tlutName);
		OSAssertMsgLine(0x415, tlr, "%s: Tex/Tlut Region Callback returns NULL", "GXLoadTexObj/PreLoaded");
...
void GXLoadTexObj(GXTexObj* obj, GXTexMapID id)
{
	...
	OSAssertMsgLine(0x433, id < 8, "%s: invalid texture map ID", "GXLoadTexObj");
	OSAssertMsgLine(0x438, gx->texRegionCallback, "%s: Tex/Tlut Region Callback not set", "GXLoadTexObj");
	r = gx->texRegionCallback(obj, id);
	OSAssertMsgLine(0x43A, r, "%s: Tex/Tlut Region Callback returns NULL", "GXLoadTexObj");
...
GXTlutFmt GXGetTlutObjFmt(const GXTlutObj* tlut_obj)
{
	...
	OSAssertMsgLine(0x482, tlut_obj, "TLut Object Pointer is null");
...
u16 GXGetTlutObjNumEntries(const GXTlutObj* tlut_obj)
{
	...
	OSAssertMsgLine(0x489, tlut_obj, "TLut Object Pointer is null");
	return t->numEntries;
}
...
void GXLoadTlut(GXTlutObj* tlut_obj, u32 tlut_name)
{
	...
	OSAssertMsgLine(0x4A4, tlut_obj, "TLut Object Pointer is null");
...
{
	u32 WidthExp2;
	GXTexRegionPriv* t = (GXTexRegionPriv*)region;

	OSAssertMsgLine(0x4D8, region, "TexRegion Object Pointer is null");
	CHECK_GXBEGIN(0x4DA, "GXInitTexCacheRegion");
	OSAssertMsgLine(0x4DC, (tmem_even & 0x1F) == 0, "%s: %s pointer not aligned to 32B", "GXInitTexCacheRegion", "tmem even");
	OSAssertMsgLine(0x4DE, (tmem_odd & 0x1F) == 0, "%s: %s pointer not aligned to 32B", "GXInitTexCacheRegion", "tmem odd");
	switch (size_even) {
	...
	default:
	{
		OSAssertMsgLine(0x4E6, 0, "%s: Invalid %s size", "GXInitTexCacheRegion", "tmem even");
		break;
	}
	}
	t->image1 = 0;
	...
	default:
	{
		OSAssertMsgLine(0x4F6, 0, "%s: Invalid %s size", "GXInitTexCacheRegion", "tmem odd");
		break;
	}
	}
	t->image2 = 0;
...
void GXInitTexPreLoadRegion(GXTexRegion* region, u32 tmem_even, u32 size_even, u32 tmem_odd, u32 size_odd)
{
	...
	OSAssertMsgLine(0x51A, region, "TexRegion Object Pointer is null");
	CHECK_GXBEGIN(0x51C, "GXInitTexPreLoadRegion");
	OSAssertMsgLine(0x51E, (tmem_even & 0x1F) == 0, "%s: %s pointer not aligned to 32B", "GXInitTexPreLoadRegion", "tmem even");
	OSAssertMsgLine(0x520, (tmem_odd & 0x1F) == 0, "%s: %s pointer not aligned to 32B", "GXInitTexPreLoadRegion", "tmem odd");
	OSAssertMsgLine(0x522, (size_even & 0x1F) == 0, "%s: %s pointer not aligned to 32B", "GXInitTexPreLoadRegion", "size even");
	OSAssertMsgLine(0x524, (size_odd & 0x1F) == 0, "%s: %s pointer not aligned to 32B", "GXInitTexPreLoadRegion", "size odd");
                       ...
                       u32* size_odd)
{
	...
	OSAssertMsgLine(0x54D, region, "TexRegion Object Pointer is null");
...
{
	GXTlutRegionPriv* t = (GXTlutRegionPriv*)region;

	OSAssertMsgLine(0x580, region, "TLutRegion Object Pointer is null");
	CHECK_GXBEGIN(0x582, "GXInitTlutRegion");
	OSAssertMsgLine(0x583, (tmem_addr & 0x1FF) == 0, "%s: tmem pointer is not aligned to 512B", "GXInitTlutRegion");
	OSAssertMsgLine(0x584, tlut_size <= 0x400, "%s: tlut size exceeds 16K", "GXInitTlutRegion");
	t->loadTlut1 = 0;
	tmem_addr -= 0x80000;
...
{
	const GXTlutRegionPriv* t = (const GXTlutRegionPriv*)region;

	OSAssertMsgLine(0x59E, region, "TLutRegion Object Pointer is null");
...
void GXPreLoadEntireTexture(GXTexObj* tex_obj, GXTexRegion* region)
{
	...
	SET_REG_FIELD(0x644, loadImage3, 15, 0, t->loadCount);
	SET_REG_FIELD(0x645, loadImage3, 2, 15, t->loadFormat);
	maxLevelIndex = 0;
	nTiles        = t->loadCount;
	if (isMipMap != 0) {
	...
	if (is32bit) {
		...
		OSAssertMsgLine(0x66E, totalEven <= r->sizeEven, "GXPreLoadEntireTexture: Even tmem size does not match the texture size");
		OSAssertMsgLine(0x66F, totalEven <= r->sizeOdd, "GXPreLoadEntireTexture: Odd tmem size does not match the texture size");
	} else if (isMipMap != 0) {
		if (r->sizeEven > r->sizeOdd) {
			OSAssertMsgLine(0x674, totalEven <= r->sizeEven, "GXPreLoadEntireTexture: Even tmem size does not match the texture size");
			OSAssertMsgLine(0x675, totalOdd <= r->sizeOdd, "GXPreLoadEntireTexture: Odd tmem size does not match the texture size");
		} else {
			OSAssertMsgLine(0x678, totalEven <= r->sizeOdd, "GXPreLoadEntireTexture: Odd tmem size does not match the texture size");
			OSAssertMsgLine(0x679, totalOdd <= r->sizeEven, "GXPreLoadEntireTexture: Even tmem size does not match the texture size");
		}
	} else if (r->sizeEven > r->sizeOdd) {
		OSAssertMsgLine(0x67E, totalEven <= r->sizeEven, "GXPreLoadEntireTexture: Even tmem size does not match the texture size");
	} else {
		OSAssertMsgLine(0x680, totalOdd <= r->sizeOdd, "GXPreLoadEntireTexture: Odd tmem size does not match the texture size");
	}
#endif
	__GXFlushTextureState();
	...
	if (maxLevelIndex != 0) {
		...
		for (i = 0; i < maxLevelIndex; i++) {
			...
			__GetImageTileCount(t->format, (u16)(wd >> (i + 1)), (u16)(ht >> (i + 1)), &rowTiles, &colTiles, &cmpTiles);
...
void GXSetTexCoordScaleManually(GXTexCoordID coord, u8 enable, u16 ss, u16 ts)
{
	...
	OSAssertMsgLine(0x6D3, coord < 8, "%s: bad texcoord specified", "GXSetTexCoordScaleManually");
...
void GXSetTexCoordCylWrap(GXTexCoordID coord, u8 s_enable, u8 t_enable)
{
	...
	OSAssertMsgLine(0x6F5, coord < 8, "%s: bad texcoord specified", "GXSetTexCoordCylWrap");
...
void GXSetTexCoordBias(GXTexCoordID coord, u8 s_enable, u8 t_enable)
{
	...
	OSAssertMsgLine(0x714, coord < 8, "%s: bad texcoord specified", "GXSetTexCoordBias");
