...
SoundTableInfo soundTable[] = {
	...
	// SYSTEM SOUNDS
	{ SYSSE_ALLSTOP, JACSYS_AllStop, "SYSSE_ALLSTOP", FALSE, JACEVENT_System },
	{ SYSSE_DECIDE1, JACSYS_Decide1, "SYSSE_DECIDE1", FALSE, JACEVENT_System },
	{ SYSSE_MOVE1, JACSYS_Move1, "SYSSE_MOVE1", FALSE, JACEVENT_System },
	{ SYSSE_PAUSE, JACSYS_Pause, "SYSSE_PAUSE", FALSE, JACEVENT_System },
	{ SYSSE_EVENING_ALERT, JACSYS_EveningAlert, "SYSSE_EVENING_ALERT", FALSE, JACEVENT_System },
	{ SYSSE_COUNTDOWN, JACSYS_Countdown, "SYSSE_COUNTDOWN", FALSE, JACEVENT_System },
	{ SYSSE_CMENU_ON, JACSYS_MenuOn, "SYSSE_CMENU_ON", FALSE, JACEVENT_System },
	{ SYSSE_CMENU_OFF, JACSYS_MenuOff, "SYSSE_CMENU_OFF", FALSE, JACEVENT_System },
	{ SYSSE_CMENU_SELECT, JACSYS_MenuSelect, "SYSSE_CMENU_SELECT", FALSE, JACEVENT_System },
	{ SYSSE_CMENU_ERROR, JACSYS_MenuError, "SYSSE_CMENU_ERROR", FALSE, JACEVENT_System },
	{ SYSSE_ORIMA_LIFEDIM, JACSYS_OrimaLifeDim, "SYSSE_ORIMA_LIFEDIM", FALSE, JACEVENT_System },
	{ SYSSE_WORK_FINISH, JACSYS_WorkFinish, "SYSSE_WORK_FINISH", FALSE, JACEVENT_System },
	{ SYSSE_VIEW_CHANGE, JACSYS_ViewChange, "SYSSE_VIEW_CHANGE", FALSE, JACEVENT_System },
	{ SYSSE_CANCEL, JACSYS_Cancel, "SYSSE_CANCEL", FALSE, JACEVENT_System },
	{ SYSSE_TYPEWRITER, JACSYS_Typewriter, "SYSSE_TYPEWRITER", FALSE, JACEVENT_System },
	{ SYSSE_UNPAUSE, JACSYS_Unpause, "SYSSE_UNPAUSE", FALSE, JACEVENT_System },
	{ SYSSE_CONTAINER_OK, JACSYS_ContainerOK, "SYSSE_CONTAINER_OK", FALSE, JACEVENT_System },
	{ SYSSE_JUNGLE, JACSYS_Jungle, "SYSSE_JUNGLE", FALSE, JACEVENT_System },
	{ SYSSE_PARTS_APPEAR, JACSYS_PartsAppear, "SYSSE_PARTS_APPEAR", FALSE, JACEVENT_System },
	{ SYSSE_SELECT_MOVE, JACSYS_SelectMove, "SYSSE_SELECT_MOVE", FALSE, JACEVENT_System },
	{ SYSSE_SELECT_DECIDE, JACSYS_SelectDecide, "SYSSE_SELECT_DECIDE", FALSE, JACEVENT_System },
	{ SYSSE_TIME_SIGNAL, JACSYS_TimeSignal, "SYSSE_TIME_SIGNAL", FALSE, JACEVENT_System },
	{ SYSSE_SELECT_COURSEOPEN, JACSYS_SelectCourseOpen, "SYSSE_SELECT_COURSEOPEN", FALSE, JACEVENT_System },
	{ SYSSE_MESSAGE_CLOSE, JACSYS_MessageClose, "SYSSE_MESSAGE_CLOSE", FALSE, JACEVENT_System },
	{ SYSSE_CARDACCESS, JACSYS_CardAccess, "SYSSE_CARDACCESS", FALSE, JACEVENT_System },
	{ SYSSE_CARDOK, JACSYS_CardOK, "SYSSE_CARDOK", FALSE, JACEVENT_System },
	{ SYSSE_CARDERROR, JACSYS_CardError, "SYSSE_CARDERROR", FALSE, JACEVENT_System },
	{ SYSSE_TIME_SMALLSIGNAL, JACSYS_TimeSmallSignal, "SYSSE_TIME_SMALLSIGNAL", FALSE, JACEVENT_System },
	{ SYSSE_CHG_HISCORE, JACSYS_ChgHiScore, "SYSSE_CHG_HISCORE", FALSE, JACEVENT_System },
	{ YMENU_ON, JACSYS_MenuOn, "YMENU ON", FALSE, JACEVENT_System },
	{ YMENU_OFF, JACSYS_MenuOff, "YMENU OFF", FALSE, JACEVENT_System },
	{ YMENU_SELECT, JACSYS_MenuSelect, "YMENU SELECT", FALSE, JACEVENT_System },
	{ SYSSE_YMENU_ZOOMIN, JACSYS_MenuZoomIn, "SYSSE_YMENU_ZOOMIN", FALSE, JACEVENT_System },
	{ SYSSE_YMENU_ZOOMOUT, JACSYS_MenuZoomOut, "SYSSE_YMENU_ZOOMOUT", FALSE, JACEVENT_System },
	...
	{ SE_PIKI_PULLING, JACORIMA_PikiPulling, "SE_PIKI_PULLING", FALSE, JACEVENT_Player },
	{ SE_PIKI_PULLED2, JACORIMA_PikiPulled2, "SE_PIKI_PULLED2", FALSE, JACEVENT_Player },
	{ SE_PLAYER_PUNCH, JACORIMA_PlayerPunch, "SE_PLAYER_PUNCH", FALSE, JACEVENT_Player },
	{ SE_THROW, JACORIMA_Throw, "SE_THROW", FALSE, JACEVENT_Player },
	{ SE_BREAKUP, JACORIMA_Breakup, "SE_BREAKUP", FALSE, JACEVENT_Player },
	{ SE_GATHER, JACORIMA_Gather, "SE_GATHER", FALSE, JACEVENT_Player },
	{ SE_MOVEOBJ, JACORIMA_MoveObj, "SE_MOVEOBJ", FALSE, JACEVENT_Player },
	{ SE_DAMAGED, JACORIMA_Damaged, "SE_DAMAGED", FALSE, JACEVENT_Player },
	{ SE_FIRED, JACORIMA_Fired, "SE_FIRED", FALSE, JACEVENT_Player },
	{ SE_PLAYER_DOWN, JACORIMA_PlayerDown, "SE_PLAYER_DOWN", FALSE, JACEVENT_Player },
	{ SE_PLAYER_TOUCHHONEY, JACORIMA_PlayerTouchHoney, "SE_PLAYER_TOUCHHONEY", FALSE, JACEVENT_Player },

	// MISC PIKI SOUNDS?
	{ SE_THROWHIT, JACORIMA_ThrowHit, "SE_THROWHIT", FALSE, JACEVENT_Player },
	{ SE_PIKI_FLY, JACORIMA_PikiFly, "SE_PIKI_FLY", FALSE, JACEVENT_Player },
	{ SE_BREAKUP_PIKI_VOICE, JACORIMA_PikiBreakupVoice, "SE_BREAKUP_PIKI_VOICE", FALSE, JACEVENT_Player },
	{ SE_PIKI_FLYREADY, JACORIMA_PikiFlyReady, "SE_PIKI_FLYREADY", FALSE, JACEVENT_Player },
	{ SE_PIKI_CALLED, JACORIMA_PikiCalled, "SE_PIKI_CALLED", FALSE, JACEVENT_Player },
	{ SE_PIKI_FIND, JACORIMA_PikiFind, "SE_PIKI_FIND", FALSE, JACEVENT_Player },
	{ SE_PIKI_PULLED, JACORIMA_PikiPulled, "SE_PIKI_PULLED", FALSE, JACEVENT_Player },
	{ SE_PIKI_WATERDROP, JACORIMA_PikiWaterDrop, "SE_PIKI_WATERDROP", FALSE, JACEVENT_Player },
	{ SE_PIKI_ATTACHENEMY, JACORIMA_PikiAttachEnemy, "SE_PIKI_ATTACHENEMY", FALSE, JACEVENT_Player },
