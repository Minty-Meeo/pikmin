...
#define __OSModuleInfoList (*(struct OSModuleQueue*)(OS_BASE_CACHED | OS_MODULE_LIST_ADDR))
#define __OSStringTable    (*(const void**)(OS_BASE_CACHED | OS_STRING_TABLE_ADDR))
