...
public:
	...
	struct Parms : public Parameters {
		inline Parms()
		    ...
		    , mNormalMinLength(this, 50.0f, 0.0f, 0.0f, "s11", "通常の最小長")
		    , mMaxLengthAtSticking(this, 225.0f, 0.0f, 0.0f, "s20", "くっつき時の最大長")
		    , mMinLengthAtSticking(this, 200.0f, 0.0f, 0.0f, "s21", "くっつき時の最小長")
		    , mDistanceBetweenNuclei(this, 40.0f, 0.0f, 0.0f, "s30", "核と核の距離")
		    , mMaxStickPikiNum(this, 10.0f, 0.0f, 0.0f, "s40", "Max Stick Piki Num")
		    , mTraceMidPoint(this, 0.85f, 0.0f, 0.0f, "s50", "Trace Mid Point")
		    , mMidPointSpring(this, 0.99f, 0.0f, 0.0f, "s51", "Mid Point Spring")
		    , mDamageLengthLarge(this, 200.0f, 0.0f, 0.0f, "s60", "Damage Length 1")
		    , mDamageLengthMid(this, 100.0f, 0.0f, 0.0f, "s61", "Damage Length 2")
		    , mDamageRatioLarge(this, 50.0f, 0.0f, 0.0f, "s62", "Damage Ratio 1")
		    , mDamageRatioMid(this, 10.0f, 0.0f, 0.0f, "s63", "Damage Ratio 2")
		    , mDamageRatioSmall(this, 1.0f, 0.0f, 0.0f, "s64", "Damage Ratio 3")
		    , mContractTraceEnd(this, 0.9f, 0.0f, 0.0f, "s70", "Contract Trace End")
		    , mContractSpringEnd(this, 20.0f, 0.0f, 0.0f, "s71", "Contract End Spring")
		    , mDeadScaleSpeed(this, 500.0f, 0.0f, 0.0f, "s80", "Dead Scale Speed")
		    , mBodyHeight(this, 20.0f, 0.0f, 0.0f, "b00", "体の高さ")
		    , mBodyThicknessElongate(this, 2.0f, 0.0f, 0.0f, "b01", "体の厚さ(伸び)")
		    , mBodyThicknessContract(this, 2.0f, 0.0f, 0.0f, "b02", "体の厚さ(縮み)")
		    , mMaxRadiusCompensation(this, 100.0f, 0.0f, 0.0f, "b10", "最大半径補正")
		    , mRadiusContractionScore(this, 1000.0f, 0.0f, 0.0f, "b20", "半径収縮スコア")
		    , mVertexPositionScore(this, 50.0f, 0.0f, 0.0f, "b21", "頂点位置スコア")
		    , mTraceDrag(this, 0.7f, 0.0f, 0.0f, "b30", "Trace Creature")
		    , mSpringForce(this, 0.5f, 0.0f, 0.0f, "b31", "Creature Spring")
		    , mMaxSortCount(this, 10, 0, 0, "i00", "ソート回数")
		{
		}
