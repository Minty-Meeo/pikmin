...
#define __OSPriorInterruptMask   (*(volatile OSInterruptMask*)(OSPhysicalToCached(0x00C4)))
#define __OSCurrentInterruptMask (*(volatile OSInterruptMask*)(OSPhysicalToCached(0x00C8)))
