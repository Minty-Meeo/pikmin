...
public:
	...
	struct Parms : public Parameters {
		inline Parms()
		    ...
		    , mMaxHealth(this, 1000.0f, 0.0f, 0.0f, "b10", "体力")
		    , mLifeRecoveryTime(this, 1.0f, 0.0f, 0.0f, "b13", "リカバリー時間")
		    , mLifeRecoveryRate(this, 0.0f, 0.0f, 0.0f, "b11", "リカバリー率")
		    , _CC(this, 1.0f, 0.0f, 0.0f, "b14", "特殊攻撃効力")
		    , mBombDamageMultiplier(this, 1.0f, 0.0f, 0.0f, "b12", "爆弾効力")
		    , mLifeGaugeScale(this, 5000.0f, 0.0f, 0.0f, "c00", "ライフゲージの大きさ")
		    , mLifeGaugeHeight(this, 30.0f, 0.0f, 0.0f, "c01", "ライフゲージの高さ")
		    , mFlickChance(this, 1.0f, 0.0f, 0.0f, "d00", "振り払う確率")
		    , mFlickKnockback(this, 100.0f, 0.0f, 0.0f, "d01", "振り払いパワー")
		    , mFlickDamage(this, 0.0f, 0.0f, 0.0f, "d02", "振り払いダメージ")
		    , mRenderSphereRadius(this, 10.0f, 0.0f, 0.0f, "p00", "Draw Culling Radius")
		    , mRenderSphereHeight(this, 0.0f, 0.0f, 0.0f, "p01", "Draw Culling Height")
		    , _15C(this, 1, 0, 0, "i10", "Special Damage Count")
		    , mFlickPikiCountAB(this, 10, 0, 0, "i00", "FLICK_PIKI_COUNT_1")
		    , mFlickPikiCountBC(this, 20, 0, 0, "i01", "FLICK_PIKI_COUNT_2")
		    , mFlickPikiCountCD(this, 30, 0, 0, "i02", "FLICK_PIKI_COUNT_3")
		    , mFlickDamageCountA(this, 10, 0, 0, "i03", "FLICK_DAMAGE_COUNT_1")
		    , mFlickDamageCountB(this, 50, 0, 0, "i04", "FLICK_DAMAGE_COUNT_2")
		    , mFlickDamageCountC(this, 100, 0, 0, "i05", "FLICK_DAMAGE_COUNT_3")
		    , mFlickDamageCountD(this, 200, 0, 0, "i06", "FLICK_DAMAGE_COUNT_4")
		    , _1DC(this, 1, 0, 0, "i90", "AI Culling ( off : on )")
		{
		}
