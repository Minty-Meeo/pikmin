...
public:
	...
	struct Parms : public Parameters {
		inline Parms()
		    ...
		    , mNormalAttackRangeXZ(this, 40.0f, 0.0f, 0.0f, "p01", "攻撃範囲(x,z)")
		    , mNormalAttackRangeY(this, 25.0f, 0.0f, 0.0f, "p04", "攻撃範囲(y)")
		    , mTongueRangeXZ(this, 40.0f, 0.0f, 0.0f, "p02", "舌とピキの距離(x,z)")
		    , mTongueRangeY(this, 40.0f, 0.0f, 0.0f, "p03", "舌とピキの距離(y)")
		    , mPressAttackRadius(this, 70.0f, 0.0f, 0.0f, "p10", "しりもち範囲")
		    , mHiddenUnderneathRadius(this, 60.0f, 0.0f, 0.0f, "q10", "見失い範囲")
		    , mTongueDamageNavi(this, 25.0f, 0.0f, 0.0f, "r00", "Swallow Damage Navi")
		    , mPressDamageNavi(this, 50.0f, 0.0f, 0.0f, "r01", "Press Damage Navi")
		    , mNormalKingScale(this, 1.2f, 0.0f, 0.0f, "s00", "モデルスケール")
		    , mDetectionRadius(this, 75.0f, 0.0f, 0.0f, "s10", "出現エリア")
		    , mDispelRadius(this, 200.0f, 0.0f, 0.0f, "s20", "吹き飛ばしエリア")
		    , mDispelPower(this, 150.0f, 0.0f, 0.0f, "s21", "吹き飛ばしパワー")
		    , mDispelDamage(this, 0.0f, 0.0f, 0.0f, "s23", "吹き飛ばしダメージ")
		    , _314(this, 5.0f, 0.0f, 0.0f, "s30", "Dist From Tongue")
		    , _324(this, 50.0f, 0.0f, 0.0f, "s31", "Height From Tongue")
		    , _334(this, 50.0f, 0.0f, 0.0f, "s32", "Height From Map")
		    , mDamageScaleOscillationSpeed(this, 30.0f, 0.0f, 0.0f, "s40", "Damage Scale Speed")
		    , mDamageScaleOscillationSize(this, 0.05f, 0.0f, 0.0f, "s41", "Damage Scale Size")
		    , mJumpAttackHealthThreshold(this, 0.5f, 0.0f, 0.0f, "t00", "Jump Attack Percent")
		    , mJumpAttackNoEatBombChance(this, 0.5f, 0.0f, 0.0f, "t01", "Jump Attack Ratio(Min)")
		    , mJumpAttackEatBombChance(this, 0.9f, 0.0f, 0.0f, "t02", "Jump Attack Ratio(Max)")
		    , mJumpAttackEatBombFactor(this, 0.1f, 0.0f, 0.0f, "t03", "Eat Bomb Num Ratio")
		    , mAttackTerritoryRadius(this, 275.0f, 0.0f, 0.0f, "t10", "Jump Attack Territory")
		    , mJumpAttackRangeXZ(this, 250.0f, 0.0f, 0.0f, "t11", "Jump Attack Range")
		    , mMaxJumpAttackAngle(this, 120.0f, 0.0f, 0.0f, "t12", "Jump Attack Angle")
		    , mMaxEatPikiNum(this, MAX_PIKI_ON_FIELD, 0, 0, "i00", "1アタック最大食い数")
		    , mSwallowedBombsMin(this, 0, 0, 0, "i10", "飲み込んだ爆弾(Min)")
		    , mSwallowedBombsMax(this, 10, 0, 0, "i11", "飲み込んだ爆弾(Max)")
		    , mEatBombDamageLoopMin(this, 4, 0, 0, "i12", "ダメージループ(Min)")
		    , mEatBombDamageLoopMid(this, 4, 0, 0, "i13", "ダメージループ(Mid)")
		    , mEatBombDamageLoopMax(this, 6, 0, 0, "i14", "ダメージループ(Max)")
		    , mHitTongueBombsMin(this, 0, 0, 0, "i20", "舌で爆発した爆弾(Min)")
		    , mHitTongueBombsMax(this, 10, 0, 0, "i21", "舌で爆発した爆弾(Max)")
		    , mHitBombDamageLoopMin(this, 4, 0, 0, "i22", "ダメージループ(Min)")
		    , mHitBombDamageLoopMid(this, 4, 0, 0, "i23", "ダメージループ(Mid)")
		    , mHitBombDamageLoopMax(this, 6, 0, 0, "i24", "ダメージループ(Max)")
		    , mTongueRollLoopCount(this, 2, 0, 0, "i30", "攻撃ループ回数")
		    , mMaxConsecutiveJumpAttacks(this, 3, 0, 0, "i40", "ジャンプアタック回数")
		{
		}
