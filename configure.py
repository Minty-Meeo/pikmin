...
config.libs = [
    ...
    },
    {
        ...
        "objects": [
            ...
            Object(not MatchingFor("G98P01_PIKIDEMO"), "sysCommon/baseApp.cpp", mw_version = "GC/1.3.2" if version_num == 6 else "GC/1.2.5n"),
            Object(not MatchingFor("G98P01_PIKIDEMO"), "sysCommon/stream.cpp", mw_version = "GC/1.3.2" if version_num == 6 else "GC/1.2.5n"),
            Object(not MatchingFor("G98P01_PIKIDEMO"), "sysCommon/streamBufferedInput.cpp", mw_version = "GC/1.3.2" if version_num == 6 else "GC/1.2.5n"),
