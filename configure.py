...
config.libs = [
    ...
    },
    {
        ...
        "objects": [
            ...
            Object(not MatchingFor("GPIP01_00"), "plugPikiOgawa/ogRader.cpp"),
    ...
    DolphinLib(
        "os",
        [
            Object(not MatchingFor("GPIP01_00"), "os/OS.c"),
            Object(not MatchingFor("GPIP01_00"), "os/OSAlarm.c"),
            Object(Matching, "os/OSAlloc.c"),
            Object(Matching, "os/OSArena.c"),
            Object(not MatchingFor("GPIP01_00"), "os/OSAudioSystem.c"),
            Object(not MatchingFor("GPIP01_00"), "os/OSCache.c"),
            Object(Matching, "os/OSContext.c"),
            Object(not MatchingFor("GPIP01_00"), "os/OSError.c"),
            Object(not MatchingFor("G98E01_PIKIDEMO"), "os/OSExi.c"),
            Object(Matching, "os/OSFont.c"),
            Object(not MatchingFor("GPIP01_00"), "os/OSInterrupt.c"),
            Object(Matching, "os/OSLink.c"),
            Object(not MatchingFor("GPIP01_00"), "os/OSMessage.c"),
            Object(not MatchingFor("GPIP01_00"), "os/OSMemory.c"),
            Object(not MatchingFor("GPIP01_00"), "os/OSMutex.c"),
            Object(not MatchingFor("GPIP01_00"), "os/OSReboot.c"),
            Object(not MatchingFor("GPIP01_00"), "os/OSReset.c"),
            Object(not MatchingFor("GPIP01_00"), "os/OSResetSW.c"),
            Object(not MatchingFor("GPIP01_00"), "os/OSRtc.c"),
            ...
            Object(not MatchingFor("GPIP01_00"), "os/__start.c"),
